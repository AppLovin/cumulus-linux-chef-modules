...
attribute :min_links, kind_of: String, default: '1'
attribute :mode, kind_of: String, default: '802.3ad'
attribute :miimon, kind_of: String, default: '100'
attribute :xmit_hash_policy, kind_of: String, default: 'layer3+4'
attribute :lacp_rate, kind_of: String, default: '1'
attribute :lacp_bypass_allow, kind_of: [String, NilClass]
attribute :lacp_bypass_period, kind_of: [String, NilClass]
...
attribute :clag_id, kind_of: [String, NilClass]
...
attribute :use_carrier, kind_of: [String, NilClass], default: '1'
attribute :bridge_access, kind_of: [String, NilClass]
